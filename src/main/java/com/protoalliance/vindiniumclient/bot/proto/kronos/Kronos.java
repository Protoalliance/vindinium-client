 ...
 */
public class Kronos implements ProtoBot{
    private Blackboard bb;
    private MainLogicSelector seq;
    private static final Logger logger = LogManager.getLogger(Kronos.class);

    public Kronos(){
        bb = new Blackboard();
        seq = new MainLogicSelector(bb);
    }
