 ...
 */
public class BloodAndGoldDrunkBot implements ProtoBot{
    private Blackboard bb;
    private DrinkOrKillSelector seq;
    private static final Logger logger = LogManager.getLogger(BloodAndGoldDrunkBot.class);

    public BloodAndGoldDrunkBot(){
        bb = new Blackboard();
